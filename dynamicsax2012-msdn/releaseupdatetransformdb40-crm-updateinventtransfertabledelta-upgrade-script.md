---
title: ReleaseUpdateTransformDB40_CRM.updateInventTransferTableDelta Upgrade Script
TOCTitle: ReleaseUpdateTransformDB40_CRM.updateInventTransferTableDelta Upgrade Script
ms:assetid: f5263e45-2d7e-aa97-ccb6-495fecc560d5
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/JJ737539(v=AX.60)
ms:contentKeyID: 49712233
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ReleaseUpdateTransformDB40\_CRM.updateInventTransferTableDelta Upgrade Script [AX 2012]
...
This upgrade is required in order to convert postal address data to the new logistics postal address model for Microsoft Dynamics AX 2012. The delivery postal address for the InventTransferTable record will be kept as a reference to the LogisticsPostalAddress record.
