---
title: ReleaseUpdateTransformDB40_Transptn.projProposalJourPreUpgradeProcess Upgrade Script
TOCTitle: ReleaseUpdateTransformDB40_Transptn.projProposalJourPreUpgradeProcess Upgrade Script
ms:assetid: 0bbacc2e-d9cf-f385-e3d0-b6ee27ff0bef
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/JJ735657(v=AX.60)
ms:contentKeyID: 49706569
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ReleaseUpdateTransformDB40\_Transptn.projProposalJourPreUpgradeProcess Upgrade Script 
...
This method inserts records into the TransportationDocument and TransportationVehicle tables from the ProjProposalJour and PurchAdditionalProperties\_W tables. It also updates the ProjProposalJour table to reference the inserted TransportationDocument record.
