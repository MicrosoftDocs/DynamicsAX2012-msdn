---
title: ReleaseUpdateTransformDB40_Transptn.custPackSlipJourPreUpgradeProcess Upgrade Script
TOCTitle: ReleaseUpdateTransformDB40_Transptn.custPackSlipJourPreUpgradeProcess Upgrade Script
ms:assetid: 5a32cf71-126c-c794-652a-a30a6ad422ff
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/JJ736281(v=AX.60)
ms:contentKeyID: 49708456
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ReleaseUpdateTransformDB40\_Transptn.custPackSlipJourPreUpgradeProcess Upgrade Script [AX 2012]
...
This method inserts records into the TransportationDocument and TransportationVehicle tables from the CustPackingSlipJour table. It also updates the CustPackingSlipJour table to reference the inserted TransportationDocument record.
