---
title: ReleaseUpdateTransformDB50_CRM.updateCustInvoiceJourDelta Upgrade Script
TOCTitle: ReleaseUpdateTransformDB50_CRM.updateCustInvoiceJourDelta Upgrade Script
ms:assetid: bc9f1c10-50ec-29ac-02ac-f3d72b815c92
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/JJ686649(v=AX.60)
ms:contentKeyID: 49710858
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ReleaseUpdateTransformDB50\_CRM.updateCustInvoiceJourDelta Upgrade Script [AX 2012]
...
This upgrade is required in order to convert postal address data to the new logistics postal address model for Microsoft Dynamics AX 2012. The delivery postal address for CustInvoiceJour table will be kept as a reference to the LogisticsPostalAddress record.
