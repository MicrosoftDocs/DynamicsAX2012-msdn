---
title: ReleaseUpdateTransformDB40_Transptn.purchTablePreUpgradeProcess Upgrade Script
TOCTitle: ReleaseUpdateTransformDB40_Transptn.purchTablePreUpgradeProcess Upgrade Script
ms:assetid: e1b5af11-bc98-7c41-a67b-9477474491b9
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/JJ737310(v=AX.60)
ms:contentKeyID: 49711752
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ReleaseUpdateTransformDB40\_Transptn.purchTablePreUpgradeProcess Upgrade Script [AX 2012]
...
This method inserts records into the TransportationDocument and TransportationVehicle tables from the PurchTable and PurchAdditionalProperties\_W tables. It also updates the PurchTable table to reference the inserted TransportationDocument record.
