---
title: AxDatePicker
TOCTitle: AxDatePicker
ms:assetid: 68236514-215e-4752-bee3-d1000f0c421b
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Cc571768(v=AX.60)
ms:contentKeyID: 28119431
ms.date: 11/07/2012
...
An AxDatePicker component displays a control that allows the user to select a date value. It is typically used for non-bound fields.

## Properties

The AxDatePicker component has the following properties:
...
<td><p>Specifies the name of the client-side script that executes when the button is clicked. If the client-side script is a function, be sure to include the parentheses ().</p></td>
</tr>
<tr class="even">
<td><p>Enabled</p></td>
<td><p>Specifies whether the date picker is enabled.</p></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td><p>TargetControlId</p></td>
<td><p>The control to which the value from the date picker will be returned.</p></td>
</tr>
<tr class="odd">
<td><p>TimeTextBoxTargetControlId</p></td>
<td><p>This property is not used for Enterprise Portal.</p></td>
</tr>
<tr class="even">
<td><p>ToolTip</p></td>
...
<tr class="even">
<td><p>DateSelected</p></td>
<td><p>Occurs when a date value is selected in the control.</p></td>
</tr>
<tr class="odd">
<td><p>Disposed</p></td>
