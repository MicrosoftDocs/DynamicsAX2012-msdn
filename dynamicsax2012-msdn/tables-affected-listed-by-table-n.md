---
title: Tables Affected, Listed by Table, N
TOCTitle: N
ms:assetid: 6833e2ad-8e46-437f-afde-9fecf871f99d
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/JJ837163(v=AX.60)
ms:contentKeyID: 49940392
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# Tables Affected, Listed by Table, N 
...
This topic lists the tables whose names begin with the letter **N**.
...
## NGPCodesTable\_FR
  ...
  -  
    [ReleaseUpdateDB60\_Cust.updateNGPCodes Upgrade Script](releaseupdatedb60-cust-updatengpcodes-upgrade-script.md)
...
## None
  ...
  -  
    ...
    [ReleaseUpdateTransformDB40\_Basic.findRegNumber\_IN Upgrade Script](releaseupdatetransformdb40-basic-findregnumber-in-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.findWithholdRegNumber\_IN Upgrade Script](releaseupdatetransformdb40-basic-findwithholdregnumber-in-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.updatePartyPostalAddrDelta Upgrade Script](releaseupdatetransformdb40-basic-updatepartypostaladdrdelta-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateAddressZipCode Upgrade Script](releaseupdatetransformdb40-basic-validateaddresszipcode-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateAxdDocumentParameters Upgrade Script](releaseupdatetransformdb40-basic-validateaxddocumentparameters-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateCompanyInfo Upgrade Script](releaseupdatetransformdb40-basic-validatecompanyinfo-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateContactPersonRecordsWithoutName Upgrade Script](releaseupdatetransformdb40-basic-validatecontactpersonrecordswithoutname-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateCustTableRecordsWithoutName Upgrade Script](releaseupdatetransformdb40-basic-validatecusttablerecordswithoutname-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateDataLossContractor Upgrade Script](releaseupdatetransformdb40-basic-validatedatalosscontractor-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateDataLossHRMMunicipal Upgrade Script](releaseupdatetransformdb40-basic-validatedatalosshrmmunicipal-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateEmployeeWithWorkCenterType Upgrade Script](releaseupdatetransformdb40-basic-validateemployeewithworkcentertype-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateEmplTable Upgrade Script](releaseupdatetransformdb40-basic-validateempltable-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateEmplTableRecordsWithoutName Upgrade Script](releaseupdatetransformdb40-basic-validateempltablerecordswithoutname-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validatePositionWithRoleType Upgrade Script](releaseupdatetransformdb40-basic-validatepositionwithroletype-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateSMMBusRelTable Upgrade Script](releaseupdatetransformdb40-basic-validatesmmbusreltable-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validatesmmBusRelTableRecordsWithoutName Upgrade Script](releaseupdatetransformdb40-basic-validatesmmbusreltablerecordswithoutname-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validateSMMImportRelationJournal Upgrade Script](releaseupdatetransformdb40-basic-validatesmmimportrelationjournal-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.validatevendTableRecordsWithoutName Upgrade Script](releaseupdatetransformdb40-basic-validatevendtablerecordswithoutname-upgrade-script.md)
    ...
    [ReleaseUpdateTransformDB40\_HRM.validateHRMAbsenceCode Upgrade Script](releaseupdatetransformdb40-hrm-validatehrmabsencecode-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_HRM.validateHRMCourseAttendee Upgrade Script](releaseupdatetransformdb40-hrm-validatehrmcourseattendee-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_HRM.validateHRMCourseTable Upgrade Script](releaseupdatetransformdb40-hrm-validatehrmcoursetable-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_HRM.validateHRMCourseType Upgrade Script](releaseupdatetransformdb40-hrm-validatehrmcoursetype-upgrade-script.md)
    ...
    [ReleaseUpdateTransformDB40\_Prod.cleanupProcessedDeltaRecords](releaseupdatetransformdb40-prod-cleanupprocesseddeltarecords.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateBOMFormReportFinish Upgrade Script](releaseupdatetransformdb40-prod-validatebomformreportfinish-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateDeltaEmptyInterCompanyInventDim](releaseupdatetransformdb40-prod-validatedeltaemptyintercompanyinventdim.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateDeltaEmptyInterCompanyInventDim Upgrade Script](releaseupdatetransformdb40-prod-validatedeltaemptyintercompanyinventdim-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateForecastPurch Upgrade Script](releaseupdatetransformdb40-prod-validateforecastpurch-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateForecastSales Upgrade Script](releaseupdatetransformdb40-prod-validateforecastsales-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullDeletedLoc Upgrade Script](releaseupdatetransformdb40-prod-validatefulldeletedloc-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullEmptyInterCompanyInventDim Upgrade Script](releaseupdatetransformdb40-prod-validatefullemptyintercompanyinventdim-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullEmptyInterCompanyInventSum Upgrade Script](releaseupdatetransformdb40-prod-validatefullemptyintercompanyinventsum-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullEmptyInventQuarantineOrder Upgrade Script](releaseupdatetransformdb40-prod-validatefullemptyinventquarantineorder-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullEmptyInventSumDelta Upgrade Script](releaseupdatetransformdb40-prod-validatefullemptyinventsumdelta-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullEmptyInventSumDeltaDim Upgrade Script](releaseupdatetransformdb40-prod-validatefullemptyinventsumdeltadim-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullEmptyInventTransferJourLine Upgrade Script](releaseupdatetransformdb40-prod-validatefullemptyinventtransferjourline-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullEmptyInventTransferLine Upgrade Script](releaseupdatetransformdb40-prod-validatefullemptyinventtransferline-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullEmptyInventTransOnSameSite Upgrade Script](releaseupdatetransformdb40-prod-validatefullemptyinventtransonsamesite-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullEmptyWMSOrder Upgrade Script](releaseupdatetransformdb40-prod-validatefullemptywmsorder-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullEmptyWMSOrderTrans Upgrade Script](releaseupdatetransformdb40-prod-validatefullemptywmsordertrans-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullFinancialDimensionSetup Upgrade Script](releaseupdatetransformdb40-prod-validatefullfinancialdimensionsetup-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullIntercompanySetup Upgrade Script](releaseupdatetransformdb40-prod-validatefullintercompanysetup-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullInventDimIdImpl Upgrade Script](releaseupdatetransformdb40-prod-validatefullinventdimidimpl-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullPhysicaDimensionSetup Upgrade Script](releaseupdatetransformdb40-prod-validatefullphysicadimensionsetup-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullProdOrderSetup Upgrade Script](releaseupdatetransformdb40-prod-validatefullprodordersetup-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullSiteConfigCompleteness Upgrade Script](releaseupdatetransformdb40-prod-validatefullsiteconfigcompleteness-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateFullWMSShipmentSetup Upgrade Script](releaseupdatetransformdb40-prod-validatefullwmsshipmentsetup-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateMarkupTable Upgrade Script](releaseupdatetransformdb40-prod-validatemarkuptable-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateProdBOM Upgrade Script](releaseupdatetransformdb40-prod-validateprodbom-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateProdGroup Upgrade Script](releaseupdatetransformdb40-prod-validateprodgroup-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateProdJouranlRoute Upgrade Script](releaseupdatetransformdb40-prod-validateprodjouranlroute-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateProdJournalBOM Upgrade Script](releaseupdatetransformdb40-prod-validateprodjournalbom-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateProdParmHistoricalCost Upgrade Script](releaseupdatetransformdb40-prod-validateprodparmhistoricalcost-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateProdRoute Upgrade Script](releaseupdatetransformdb40-prod-validateprodroute-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateProdRouteTrans Upgrade Script](releaseupdatetransformdb40-prod-validateprodroutetrans-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateProdTable Upgrade Script](releaseupdatetransformdb40-prod-validateprodtable-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateProjControlPeriodTable Upgrade Script](releaseupdatetransformdb40-prod-validateprojcontrolperiodtable-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validatePurchLine Upgrade Script](releaseupdatetransformdb40-prod-validatepurchline-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validatePurchTable Upgrade Script](releaseupdatetransformdb40-prod-validatepurchtable-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateRouteCostCategory Upgrade Script](releaseupdatetransformdb40-prod-validateroutecostcategory-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateSiteStructureDefined Upgrade Script](releaseupdatetransformdb40-prod-validatesitestructuredefined-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateSMAAgreementLine Upgrade Script](releaseupdatetransformdb40-prod-validatesmaagreementline-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateSMAServiceOrderLine Upgrade Script](releaseupdatetransformdb40-prod-validatesmaserviceorderline-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateWrkCtrGroupTaskGroupMembership Upgrade Script](releaseupdatetransformdb40-prod-validatewrkctrgrouptaskgroupmembership-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateWrkCtrTable Upgrade Script](releaseupdatetransformdb40-prod-validatewrkctrtable-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateWrkCtrTableEmplIdField](releaseupdatetransformdb40-prod-validatewrkctrtableemplidfield.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateWrkCtrTableEmplIdField Upgrade Script](releaseupdatetransformdb40-prod-validatewrkctrtableemplidfield-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateWrkCtrTableGroupNotVendorType Upgrade Script](releaseupdatetransformdb40-prod-validatewrkctrtablegroupnotvendortype-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateWrkCtrTableGroupSameVendId Upgrade Script](releaseupdatetransformdb40-prod-validatewrkctrtablegroupsamevendid-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateWrkCtrTableGroupVendorType Upgrade Script](releaseupdatetransformdb40-prod-validatewrkctrtablegroupvendortype-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateWrkCtrTableVendorField Upgrade Script](releaseupdatetransformdb40-prod-validatewrkctrtablevendorfield-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Prod.validateWrkCtrTaskGroupMembership Upgrade Script](releaseupdatetransformdb40-prod-validatewrkctrtaskgroupmembership-upgrade-script.md)
    ...
    [ReleaseUpdateTransformDB40\_Transptn.moduleName Upgrade Script](releaseupdatetransformdb40-transptn-modulename-upgrade-script.md)
    ...
    [ReleaseUpdateTransformDB50\_Basic.EximPorts\_INDeltaPreUpgradeProcess](releaseupdatetransformdb50-basic-eximports-indeltapreupgradeprocess.md)
    
    [ReleaseUpdateTransformDB50\_Basic.EximPorts\_INPreUpgradeProcess](releaseupdatetransformdb50-basic-eximports-inpreupgradeprocess.md)
    
    [ReleaseUpdateTransformDB50\_Basic.findRegNumber\_IN Upgrade Script](releaseupdatetransformdb50-basic-findregnumber-in-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.findWithholdRegNumber\_IN Upgrade Script](releaseupdatetransformdb50-basic-findwithholdregnumber-in-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.taxRegNumber\_INDeltaPreUpgradeProcess](releaseupdatetransformdb50-basic-taxregnumber-indeltapreupgradeprocess.md)
    
    [ReleaseUpdateTransformDB50\_Basic.taxRegNumber\_INPreUpgradeProcess](releaseupdatetransformdb50-basic-taxregnumber-inpreupgradeprocess.md)
    
    [ReleaseUpdateTransformDB50\_Basic.taxWithholdRegNum\_INDeltaUpgProcess](releaseupdatetransformdb50-basic-taxwithholdregnum-indeltaupgprocess.md)
    
    [ReleaseUpdateTransformDB50\_Basic.taxWithholdRegNum\_INPreUpgProcess](releaseupdatetransformdb50-basic-taxwithholdregnum-inpreupgprocess.md)
    
    [ReleaseUpdateTransformDB50\_Basic.update\_ProdJournalRoute\_GAB\_Worker Upgrade Script](releaseupdatetransformdb50-basic-update-prodjournalroute-gab-worker-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.update\_RouteCostCategory\_GAB\_Worker Upgrade Script](releaseupdatetransformdb50-basic-update-routecostcategory-gab-worker-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.update\_SMAAgreementLine\_GAB\_Worker Upgrade Script](releaseupdatetransformdb50-basic-update-smaagreementline-gab-worker-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.update\_WMSOrderTrans\_Worker\_Live](releaseupdatetransformdb50-basic-update-wmsordertrans-worker-live.md)
    
    [ReleaseUpdateTransformDB50\_Basic.update\_WMSPickingRoute\_Worker\_Delta](releaseupdatetransformdb50-basic-update-wmspickingroute-worker-delta.md)
    
    [ReleaseUpdateTransformDB50\_Basic.update\_WMSPickingRoute\_Worker\_Live](releaseupdatetransformdb50-basic-update-wmspickingroute-worker-live.md)
    
    [ReleaseUpdateTransformDB50\_Basic.update\_WMSTransport\_Worker\_Live](releaseupdatetransformdb50-basic-update-wmstransport-worker-live.md)
    
    [ReleaseUpdateTransformDB50\_Basic.updateCustTableTaxRegNumDelta\_CN](releaseupdatetransformdb50-basic-updatecusttabletaxregnumdelta-cn.md)
    
    [ReleaseUpdateTransformDB50\_Basic.updateCustTableTaxRegNumPreProcessing\_CN](releaseupdatetransformdb50-basic-updatecusttabletaxregnumpreprocessing-cn.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateAddressZipCode Upgrade Script](releaseupdatetransformdb50-basic-validateaddresszipcode-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateAxdDocumentParameters Upgrade Script](releaseupdatetransformdb50-basic-validateaxddocumentparameters-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateCompanyInfo Upgrade Script](releaseupdatetransformdb50-basic-validatecompanyinfo-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateContactPersonParties Upgrade Script](releaseupdatetransformdb50-basic-validatecontactpersonparties-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateDataLossContractor Upgrade Script](releaseupdatetransformdb50-basic-validatedatalosscontractor-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateDataLossHRMMunicipal Upgrade Script](releaseupdatetransformdb50-basic-validatedatalosshrmmunicipal-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateEmployeeStartDate Upgrade Script](releaseupdatetransformdb50-basic-validateemployeestartdate-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateEmployeeSwitchEmployeeType Upgrade Script](releaseupdatetransformdb50-basic-validateemployeeswitchemployeetype-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateEmployeeTerminatedStatus Upgrade Script](releaseupdatetransformdb50-basic-validateemployeeterminatedstatus-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateEmployeeTerminationDate Upgrade Script](releaseupdatetransformdb50-basic-validateemployeeterminationdate-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateEmployeeWithWorkCenterType Upgrade Script](releaseupdatetransformdb50-basic-validateemployeewithworkcentertype-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateEmplTable Upgrade Script](releaseupdatetransformdb50-basic-validateempltable-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateHRMApplicantRecordsWithoutName Upgrade Script](releaseupdatetransformdb50-basic-validatehrmapplicantrecordswithoutname-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateHrmVirtualNetworkAccommodation Upgrade Script](releaseupdatetransformdb50-basic-validatehrmvirtualnetworkaccommodation-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateInvalidEmployeeData Upgrade Script](releaseupdatetransformdb50-basic-validateinvalidemployeedata-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateJobWithRoleType Upgrade Script](releaseupdatetransformdb50-basic-validatejobwithroletype-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validatePartyEntityPartyIDRequired Upgrade Script](releaseupdatetransformdb50-basic-validatepartyentitypartyidrequired-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validatePartyRelationshipDuplicates Upgrade Script](releaseupdatetransformdb50-basic-validatepartyrelationshipduplicates-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateRecordsWithManualNameSequence Upgrade Script](releaseupdatetransformdb50-basic-validaterecordswithmanualnamesequence-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateRecordsWithoutName Upgrade Script](releaseupdatetransformdb50-basic-validaterecordswithoutname-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateSalesUnitMembersEmployees Upgrade Script](releaseupdatetransformdb50-basic-validatesalesunitmembersemployees-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateSMMBusRelTable Upgrade Script](releaseupdatetransformdb50-basic-validatesmmbusreltable-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateSMMImportRelationJournal Upgrade Script](releaseupdatetransformdb50-basic-validatesmmimportrelationjournal-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.validateWorkflow Upgrade Script](releaseupdatetransformdb50-basic-validateworkflow-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_CRM.updateWMSOrder](releaseupdatetransformdb50-crm-updatewmsorder.md)
    
    [ReleaseUpdateTransformDB50\_CRM.updateWMSOrderDelta](releaseupdatetransformdb50-crm-updatewmsorderdelta.md)
    
    [ReleaseUpdateTransformDB50\_CRM.updateWMSOrderTrans](releaseupdatetransformdb50-crm-updatewmsordertrans.md)
    
    [ReleaseUpdateTransformDB50\_CRM.updateWMSOrderTransDelta](releaseupdatetransformdb50-crm-updatewmsordertransdelta.md)
    
    [ReleaseUpdateTransformDB50\_CRM.updateWMSPickingRoute](releaseupdatetransformdb50-crm-updatewmspickingroute.md)
    
    [ReleaseUpdateTransformDB50\_CRM.updateWMSPickingRouteDelta](releaseupdatetransformdb50-crm-updatewmspickingroutedelta.md)
    ...
    [ReleaseUpdateTransformDB50\_Prod.ProdRouteTransPreUpgradeProWIPIssue\_IN](releaseupdatetransformdb50-prod-prodroutetranspreupgradeprowipissue-in.md)
    ...
    [ReleaseUpdateTransformDB50\_Prod.validateMarkupTable Upgrade Script](releaseupdatetransformdb50-prod-validatemarkuptable-upgrade-script.md)
    ...
    [ReleaseUpdateTransformDB50\_Prod.validateWrkCtrTable Upgrade Script](releaseupdatetransformdb50-prod-validatewrkctrtable-upgrade-script.md)
    ...
    [ReleaseUpdateDB60\_Basic.createDirPersonExternalUser Upgrade Script](releaseupdatedb60-basic-createdirpersonexternaluser-upgrade-script.md)
    
    [ReleaseUpdateDB60\_Basic.createDirPersonInternalUser Upgrade Script](releaseupdatedb60-basic-createdirpersoninternaluser-upgrade-script.md)
    
    [ReleaseUpdateDB60\_Basic.updateExternalFiscalDocumentTable\_BR Upgrade Script](releaseupdatedb60-basic-updateexternalfiscaldocumenttable-br-upgrade-script.md)
    ...
    [ReleaseUpdateDB60\_COS.executeStatement](releaseupdatedb60-cos-executestatement.md)
    
    [ReleaseUpdateDB60\_COS.getDimensionEnumerator](releaseupdatedb60-cos-getdimensionenumerator.md)
    
    [ReleaseUpdateDB60\_COS.updateCOSParameters Upgrade Script](releaseupdatedb60-cos-updatecosparameters-upgrade-script.md)
    
    [ReleaseUpdateDB60\_COS.updateCostDimensionsInTable](releaseupdatedb60-cos-updatecostdimensionsintable.md)
    
    [ReleaseUpdateDB60\_Cust.createCustBOEEndorseVoucherNumSeq\_JP Upgrade Script](releaseupdatedb60-cust-createcustboeendorsevouchernumseq-jp-upgrade-script.md)
    
    [ReleaseUpdateDB60\_Cust.initDataAreaIdMap Upgrade Script](releaseupdatedb60-cust-initdataareaidmap-upgrade-script.md)
    ...
    [ReleaseUpdateDB60\_Invent.updateInventItemSetupSupplyType Upgrade Script](releaseupdatedb60-invent-updateinventitemsetupsupplytype-upgrade-script.md)
    
    [ReleaseUpdateDB60\_Invent.updateInventJournalName](releaseupdatedb60-invent-updateinventjournalname.md)
    
    [ReleaseUpdateDB60\_Invent.updateInventNonConformanceTable](releaseupdatedb60-invent-updateinventnonconformancetable.md)
    ...
    [ReleaseUpdateDB60\_Vend.initDataAreaIdMap Upgrade Script](releaseupdatedb60-vend-initdataareaidmap-upgrade-script.md)
...
## NubmersequenceTTS
  ...
  -  
    [ReleaseUpdateDB60\_Basic.updateNumberSequenceFrameworkPreSync Upgrade Script](releaseupdatedb60-basic-updatenumbersequenceframeworkpresync-upgrade-script.md)
...
## NumberSequenceDatatype
  ...
  -  
    [ReleaseUpdateDB60\_Basic.updateACONumberSequenceReference\_BR Upgrade Script](releaseupdatedb60-basic-updateaconumbersequencereference-br-upgrade-script.md)
...
## NumberSequenceDataType
  ...
  -  
    [ReleaseUpdateDB60\_Basic.updateDirNumberSequences Upgrade Script](releaseupdatedb60-basic-updatedirnumbersequences-upgrade-script.md)
...
## numbersequencedataypeparametertypes
...
## NumberSequenceList
  ...
  -  
    ...
    [ReleaseUpdateDB60\_Basic.upgradeNumberSequenceTables Upgrade Script](releaseupdatedb60-basic-upgradenumbersequencetables-upgrade-script.md)
...
## NumberSequenceReference
  ...
  -  
    ...
    [ReleaseUpdateTransformDB40\_Basic.createAgreementIdNumberSequence\_RU Upgrade Script](releaseupdatetransformdb40-basic-createagreementidnumbersequence-ru-upgrade-script.md)
    
    [ReleaseUpdateTransformDB40\_Basic.getAgreementId\_RU Upgrade Script](releaseupdatetransformdb40-basic-getagreementid-ru-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.createAgreementIdNumberSequence\_RU Upgrade Script](releaseupdatetransformdb50-basic-createagreementidnumbersequence-ru-upgrade-script.md)
    
    [ReleaseUpdateTransformDB50\_Basic.getAgreementId\_RU Upgrade Script](releaseupdatetransformdb50-basic-getagreementid-ru-upgrade-script.md)
...
## NumberSequenceScope
  ...
  -  
    ...
    [ReleaseUpdateDB60\_Cust.updateCustInterestJour Upgrade Script](releaseupdatedb60-cust-updatecustinterestjour-upgrade-script.md)
    
    [ReleaseUpdateDB60\_Cust.updateNumberSequenceTableReference Upgrade Script](releaseupdatedb60-cust-updatenumbersequencetablereference-upgrade-script.md)
...
## nvalid user ID needs to be corrected by a user.
...
## nvalid user IDs need to be corrected by a user.
