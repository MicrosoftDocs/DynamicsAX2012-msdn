---
title: ReleaseUpdateTransformDB50_Transptn.purchTablePreUpgradeProcess Upgrade Script
TOCTitle: ReleaseUpdateTransformDB50_Transptn.purchTablePreUpgradeProcess Upgrade Script
ms:assetid: c648c9ca-5894-f38a-7270-5eff96722bf5
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/JJ719552(v=AX.60)
ms:contentKeyID: 49711120
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ReleaseUpdateTransformDB50\_Transptn.purchTablePreUpgradeProcess Upgrade Script [AX 2012]
...
Inserts records into the TransportationDocument and TransportationVehicle tables from the PurchTable and PurchAdditionalProperties\_W tables. Updates the PurchTable table to reference the inserted TransportationDocument record.
