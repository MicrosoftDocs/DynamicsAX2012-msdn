...
## TaxTrans record to hold a valid value for the AccountNum, OperationAccount, TaxOffsetAccountUseTax, and Dimension fields. These values must exist in the LedgerTable table.
...
## test
  ...
  -  
    [ReleaseUpdateDB60\_COS.test Upgrade Script](releaseupdatedb60-cos-test-upgrade-script.md)
...
## the LedgerJournalTrans records reference invalid SysCompanyUserInfo records.
...
## the values for the AccountNum and Dimension fields contain values found in the LedgerTable table.
...
## the values for the TaxTrans.AccountNum, TaxTrans.OperationAccount, TaxTrans. TaxOffsetAccountUseTax, and TaxTrans. Dimension fields contain values that are found in the LedgerTabletable.
