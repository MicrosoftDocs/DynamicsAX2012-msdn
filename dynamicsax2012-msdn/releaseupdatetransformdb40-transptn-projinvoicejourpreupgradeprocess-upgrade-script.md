---
title: ReleaseUpdateTransformDB40_Transptn.projInvoiceJourPreUpgradeProcess Upgrade Script
TOCTitle: ReleaseUpdateTransformDB40_Transptn.projInvoiceJourPreUpgradeProcess Upgrade Script
ms:assetid: d92649e4-aef4-a41d-4770-68a46ca550c2
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/JJ737141(v=AX.60)
ms:contentKeyID: 49711583
ms.date: 05/18/2015
mtps_version: v=AX.60
---

# ReleaseUpdateTransformDB40\_Transptn.projInvoiceJourPreUpgradeProcess Upgrade Script [AX 2012]
...
This upgrade script inserts records into the TransportationDocument and TransportationVehicle tables from the ProjInvoiceJour and PurchAdditionalProperties\_W tables. It also updates the ProjInvoiceJour table to reference the inserted TransportationDocument record.
